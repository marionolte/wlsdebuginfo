 ...
 */
public class SshCompressionFactory  extends Version{
    /**  */
    ...
    static {
        comps = new HashMap();
        o= new SshCompressionFactory();
        final String func=((SshCompressionFactory)o).getFunc("static");
        printf(func,2,"Loading compression methods");
            ...
            while ((en != null) && en.hasMoreElements()) {
                ...
                while (properties.getProperty("compression.name." +
                    ...
                    try {
                        ...
                        cls.newInstance();
                        comps.put(name, cls);
                        printf(func,2,"Installed " + name + " compression");
                    } catch (Throwable ex) {
                        printf(func,1,"Could not install cipher class for " + name, (Exception) ex);
                    }
