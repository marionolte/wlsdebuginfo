 ...
 */
public class SshKeyExchangeFactory extends Version {
    private static Map kexs;
    private static String defaultAlgorithm;
    //private static Log log = LogFactory.getLog(SshKeyExchangeFactory.class);

    static {
        o=new SshKeyExchangeFactory();
        final String func=((SshKeyExchangeFactory)o).getFunc("static");
        kexs = new HashMap();
        printf(func,2,"Loading key exchange methods");
                    ...
                    if (list != null) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (kexs.containsKey(name)) {
                                printf(func,2,"Standard key exchange " + name + " is being overidden by " +
                                    algorithm.getImplementationClass());
                            } else {
                                printf(func,2,algorithm.getAlgorithmName() + " key exchange is implemented by " +
                                    algorithm.getImplementationClass());
                            }
                            ...
                            try {
                                ...
                                printf(func,2,"Could not locate " + algorithm.getImplementationClass());
                            }
                        }
                    }
        ...
        if ((defaultAlgorithm == null) || !kexs.containsKey(defaultAlgorithm)) {
            printf(func,2, "The default key exchange is not set! using first in list");
