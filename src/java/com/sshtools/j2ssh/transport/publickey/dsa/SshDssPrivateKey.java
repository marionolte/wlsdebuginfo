...
class SshDssPrivateKey extends SshPrivateKey {
    ...
    public byte[] generateSignature(byte[] data) throws InvalidSshKeySignatureException {
        final String func=getFunc("generateSignature(byte[] data)");
        try {
            ...
            if ( debug > 0 ) {
                printf(func,3,"s length is " + String.valueOf(s.length));
                printf(func,3,"r length is " + String.valueOf(r.length));
                ...
                printf(func,3,"Java signature is " + str);
                str = "";
                ...
                printf(func,3,"SSH signature is " + str);
            }
