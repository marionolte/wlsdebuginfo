 ...
 */
public class SshPublicKeyFormatFactory extends Version{
...
//    private static Log log = LogFactory.getLog(SshPublicKeyFormatFactory.class);
    ...
    static {
        final String func=(new SshPublicKeyFormatFactory()).getFunc("static");
        ...
        printf(func,1,"Default public key format will be " + defaultFormat);
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                printf(func,2,"Installing " + f.getFormatType() +
                    " public key format");
                formatTypes.put(f.getFormatType(), cls);
                types.add(f.getFormatType());
            } catch (Exception iae) {
                printf(func,1,"Public key format implemented by " + classname + " will not be available", iae);
            }
        }
    }
