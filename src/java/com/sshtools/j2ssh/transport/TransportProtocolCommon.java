 ...
 */
public abstract class TransportProtocolCommon extends Version implements TransportProtocol, Runnable 
{
    ...
    public void disconnect(String description) {
        final String func=getFunc("disconnect(String description)");
        if (log.isDebugEnabled()) {
            printf(func,2,"Disconnect: " + description);
        }
        ...
        try {
            ...
            printf(func,1,"Failed to send disconnect", e);
        }
    }
    ...
    public void run() {
      ...
      try {
        ...
        printf(func,3,"Registering transport protocol messages with inputstream");
        ...
        if (state.getValue() != TransportProtocolState.DISCONNECTED) {
          printf(func,2,"The Transport Protocol thread failed", (Exception) e);
      ...
      printf(func,3,"The Transport Protocol has been stopped");
    }
        ...
        if (sender instanceof SshKeyExchange ||
            ...
            if (currentState == TransportProtocolState.CONNECTED) {
                if (sendIgnore) {
                    ...
                    if (log.isDebugEnabled()) {
                        printf(func,3,"Sending " + ignore.getMessageName());
                    }
            ...
            printf(func,3,"Adding to message queue whilst in key exchange");
    ...
    public void startTransportProtocol(TransportProvider provider,
        ...
        final String func=getFunc("startTransportProtocol(TransportProvider provider,SshConnectionProperties properties)");

        // Start the transport layer message loop
        printf(func,3,"Starting transport protocol");
    ...
    public void unregisterMessage(Integer messageId, SshMessageStore store)
        throws MessageNotRegisteredException {
        final String func=getFunc("unregisterMessage(Integer messageId, SshMessageStore store)");
        if (log.isDebugEnabled()) {
            printf(func,2,"Unregistering message Id " + messageId.toString());
        }
    ...
    protected void beginKeyExchange() throws IOException, KeyExchangeException {
        final String func=getFunc("beginKeyExchange()");
        printf(func,3,"Starting key exchange");
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                printf(func,3,"Key exchange algorithm: " + kexAlgorithm);
            }
    ...
    protected void onCorruptMac() {
        ...
        sendDisconnect(SshMsgDisconnect.MAC_ERROR, "Corrupt Mac on input", new SshException("Corrupt Mac on Imput"));
    }
    ...
    protected void sendDisconnect(int reason, String description) {
        ...
        final String func=getFunc("sendDisconnect(int reason, String description)");
        try {
    ...
    protected void sendNewKeys() throws IOException {
        final String func=getFunc("sendNewKeys()");
        // Send new keys
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                printf(func,1,"Received " + msg.getMessageName());
            }
