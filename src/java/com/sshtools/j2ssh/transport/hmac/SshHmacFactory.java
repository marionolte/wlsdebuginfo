 ...
 */
public class SshHmacFactory extends Version{
 ...
 //   private static Log log = LogFactory.getLog(SshHmacFactory.class);
    ...
    static {
        macs = new HashMap();
        o= new SshHmacFactory();
        final String func=((SshHmacFactory)o).getFunc("static");
        printf(func,2,"Loading message authentication methods");
