...
//    private static Log log = LogFactory.getLog(SocketChannel.class);
    ...
    protected void onChannelClose() throws IOException {
        ...
        try {
            ...
            printf(func,3,"Failed to close socket on channel close event: " +
                ex.getMessage());
        }
    }
    ...
    class SocketReader extends Version implements Runnable {
        public void run() {
            final String func=getFunc();
            ...
            try {
                ...
                printf(func,3,"Failed to send channel EOF message: " +
                    ex.getMessage());
            }
