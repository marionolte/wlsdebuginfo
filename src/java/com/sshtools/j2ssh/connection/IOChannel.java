...
public abstract class IOChannel extends Channel {
    ...
    protected void onChannelData(SshMsgChannelData msg) throws IOException {
        final String func=getFunc("onChannelData(SshMsgChannelData msg)");
        ...
        synchronized (incoming) {
            if (boundOutputStream != null) {
                try {
                    ...
                    printf(func,3,"Could not route data to the bound OutputStream; Closing channel. "+ex.getMessage(),ex);
                    close();
                }
            } else {
    ...
    /*public void bindIOChannel(IOChannel boundIOChannel) throws IOException {
     ...
     public void onChannelOpen(Channel channel) {
         try {
           ...
           printf(func,3,"Failed to bind the channel");
         }
     }
     public void onChannelEOF(Channel channel) {
       try {
         ...
         printf(func,3,"Failed to set the channel to EOF");
       }
     }
     public void onChannelClose(Channel channel)  {
       try {
         ...
         printf(func,3,"Failed to close the channel");
       }
     }
            ...
            while (true) {
                try {
                    ...
                    try {
                        ...
                        //printf(func,3,"Could not write outstanding messages to the bound OutputStream: "  +ex1.getMessage());
                        close();
                    }
