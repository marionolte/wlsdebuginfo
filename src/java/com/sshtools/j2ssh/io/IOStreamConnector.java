 ...
 */
public class IOStreamConnector extends Version{
    ...
    public void close() throws IOException {
        ...
        printf(func,3,"Closing IOStreamConnector");
    ...
    public void connect(InputStream in, OutputStream out) {
        final String func=getFunc("connect(InputStream in, OutputStream out)");
        this.in = in;
        this.out = out;
        printf(func,3,"Connecting InputStream to OutputStream");
    ...
    class IOStreamConnectorThread implements Runnable {
        ...
        public void run() {
            ...
            int count;
            int available;
            printf(func,3,"Starting IOStreamConnectorThread thread");
            ...
            while (state.getValue() == IOStreamConnectorState.CONNECTED) {
                try {
                    ...
                    if (read > 0) {
                        ...
                        printf(func,2,"Blocking read returned with " +
                            String.valueOf(read));
            ...
            printf(func,3,"IOStreamConnectorThread is exiting");
        }
    }
}
