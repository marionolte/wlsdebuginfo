 ...
 */
public class SshAuthenticationClientFactory extends Version{
   ...
   // private static Log log = LogFactory.getLog(SshAuthenticationClientFactory.class);
    ...
    static {
        auths = new HashMap();
        v = new Version(){};
        final String func=v.getFunc("static");
        printf(func,3,"Loading supported authentication methods");
            ...
            if (ConfigurationLoader.isConfigurationAvailable(
                ...
                while (it.hasNext()) {
                    ...
                    if (auths.containsKey(name)) {
                        printf(func,2,"Standard authentication implementation for " +
                            name + " is being overidden by " +
                            method.getImplementationClass());
                    } else {
                        printf(func,2,name + " authentication is implemented by " +
                            method.getImplementationClass());
                    }
