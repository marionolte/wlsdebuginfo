 ...
 */
public class ForwardingConfiguration extends Version{
//    private static Log log = LogFactory.getLog(ForwardingConfiguration.class);
    ...
    public class ForwardingConfigurationMonitor extends Version implements ChannelEventListener {
        public void onChannelOpen(Channel channel) {
            final String func=this.getFunc();
            if (log.isDebugEnabled()) {
                ForwardingChannel fch = (ForwardingChannel) channel;
                printf(func,2,"Opening forwarding channel from " +
        ...
        public void onChannelClose(Channel channel) {
            ...
            if (log.isDebugEnabled()) {
                ForwardingChannel fch = (ForwardingChannel) channel;
                printf(func,2,"Closing forwarding channel from " +
                    fch.getOriginatingHost() + ":" +
                    String.valueOf(fch.getOriginatingPort()));
            }
