...
class SftpMessageStore extends SubsystemMessageStore {
     ...
     */
    public synchronized SubsystemMessage getMessage(UnsignedInteger32 requestId) throws InterruptedException {
        final String func=getFunc("getMessage(UnsignedInteger32 requestId)");
        Iterator it;
        ...
        while (getState().getValue() == OpenClosedState.OPEN) {
            ...
            printf(func,2,"Waiting for new messages");
            wait(5000);
        }
