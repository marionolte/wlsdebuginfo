 ...
 */
public class SshAgentClient extends Version{
    ...
    SshAgentClient(boolean isForwarded, String application, InputStream in,
        ...
        printf(func,3,"New SshAgentClient instance created");
        this.in = in;
        this.out = out;
    ...
    public void close() {
        final String func=getFunc();
        printf(func,3,"Closing agent client");
    ...
    protected SubsystemMessage readMessage() throws InvalidMessageException {
        ...
        try {
            ...
            if (messages.containsKey(id)) {
                ...
                printf(func,3,"Received message " + msg.getMessageName());
