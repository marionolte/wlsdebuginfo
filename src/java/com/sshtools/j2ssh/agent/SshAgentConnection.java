 ...
 */
public class SshAgentConnection extends Version implements Runnable {
    ...
    protected void sendMessage(SubsystemMessage msg) throws IOException {
        ...
        printf(func,3,"Sending message " + msg.getMessageName());
    ...
    public void run() {
        final String func=getFunc();
        try {
            printf(func,3,"Starting agent connection thread");
            ...
            printf(func,3,"The agent connection terminated");
        } finally {
            try {
                socket.close();
            } catch (Exception ex) {
        ...
        printf(func,3,"Exiting agent connection thread");
    }
    ...
    protected void onMessageReceived(byte[] msgdata) throws IOException {
        ...
        case SshAgentForwardingNotice.SSH_AGENT_FORWARDING_NOTICE: {
            printf(func,3,"Agent forwarding notice received");
        ...
        case SshAgentRequestVersion.SSH_AGENT_REQUEST_VERSION: {
            printf(func,3,"Agent version request received");
        ...
        case SshAgentAddKey.SSH_AGENT_ADD_KEY: {
            printf(func,3,"Adding key to agent");
        ...
        case SshAgentDeleteAllKeys.SSH_AGENT_DELETE_ALL_KEYS: {
            printf(func,3,"Deleting all keys from agent");
        ...
        case SshAgentListKeys.SSH_AGENT_LIST_KEYS: {
            printf(func,3,"Listing agent keys");
        ...
        case SshAgentPrivateKeyOp.SSH_AGENT_PRIVATE_KEY_OP: {
            printf(func,3,"Performing agent private key operation");
        ...
        case SshAgentDeleteKey.SSH_AGENT_DELETE_KEY: {
            printf(func,3,"Deleting key from agent");
        ...
        case SshAgentPing.SSH_AGENT_PING: {
            printf(func,3,"Ping Ping Ping Ping Ping");
        ...
        case SshAgentRandom.SSH_AGENT_RANDOM: {
            printf(func,3,"Random message received");
