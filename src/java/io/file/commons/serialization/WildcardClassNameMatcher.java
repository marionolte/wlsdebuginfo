 ...
 * under the License.
 */
package io.file.commons.serialization;

import io.file.commons.FilenameUtils;

/**
 * A {@link ClassNameMatcher} that uses simplified regular expressions
 *  provided by {@link io.file.commons.FilenameUtils#wildcardMatch(String, String) FilenameUtils.wildcardMatch}
 * <p>
